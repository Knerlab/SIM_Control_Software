...
import ctypes as ct
r11 = ct.windll.LoadLibrary('C:/Users/Public/Documents/python_code/SIM_AO_p36/R11CommLib-1.7-x64.dll')

import subprocess
#filepath='C:/Program Files/MetroCon-3.3/RepTools/RepSender.exe'
#fns = 'C:/Users/Public/Documents/python_code/QXGA/10pix_3ang_5phs.repz11'
...
def repsend(fns):
    x = subprocess.run([r'C:/Program Files/MetroCon-3.3/RepTools/RepSender.exe', '-z', fns, '-d', '0175000547'], stdout=subprocess.PIPE)
    if (x.returncode==0):
        print('load the repz11 file successfully')
    else:
        raise Exception('fail to load the repz11 file')
...
def initiate():
    ...
    if (res==0):
        ...
        raise Exception('Fail to find the port')
